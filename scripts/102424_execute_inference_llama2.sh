...
#SBATCH --job-name=inference-llama2
...
<< COMMENTOUT
MODELS=("microsoft/Phi-3.5-mini-instruct" "axiong/PMC_LLaMA_13B" epfl-llm/meditron-70b meta-llama/Llama-3.1-70B meta-llama/Llama-2-70b-chat-hf
