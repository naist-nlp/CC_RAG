...
if __name__ == "__main__":
  ...
  inferenced_input_path = project_root / "YOUR_INFERENCED_OUTPUT_DIR" / f"{args.task}.{args.rag_db}.{rag_model_name}.{args.max_length}length.{base_model_name}.top{args.top_k}.inferenced.jsonl"
