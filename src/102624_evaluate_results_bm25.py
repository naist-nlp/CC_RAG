...
if __name__ == "__main__":
  ...
  inferenced_input_path = project_root / f"make_datastore_py310/data/inferenced/{args.task}.{args.rag_db}.BM25.{args.max_length}length.{base_model_name}.top{args.top_k}.inferenced.jsonl"
