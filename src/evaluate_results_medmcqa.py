...
if __name__ == "__main__":
  ...
  ans1_save_bar_graph_filename = save_dir / f"ans1.prompt{prompt_pattern}.{base_model_name}.accuracy_by_bins.png"
  ans1_other2_save_filename = save_dir / f"ans1.other2.prompt{prompt_pattern}.{base_model_name}.evaluated.jsonl"
  ans1_other2_save_line_graph_filename = save_dir / f"ans1.other2.prompt{prompt_pattern}.{base_model_name}.calibration_curve.png"
  ans1_other2_save_bar_graph_filename = save_dir / f"ans1.other2.prompt{prompt_pattern}.{base_model_name}.accuracy_by_bins.png"
  other3_save_filename = save_dir / f"other3.prompt{prompt_pattern}.{base_model_name}.evaluated.jsonl"
  other3_save_line_graph_filename = save_dir / f"other3.prompt{prompt_pattern}.{base_model_name}.calibration_curve.png"
  other3_save_bar_graph_filename = save_dir / f"other3.prompt{prompt_pattern}.{base_model_name}.accuracy_by_bins.png"

  print(f"Input file: {ans1_inferenced_input_path}")
  ans1_line_graph_data = evaluate_line_graph(
      str(ans1_inferenced_input_path), ans1_save_line_graph_filename)
  ans1_bar_graph_data = evaluate_bar_graph(
      str(ans1_inferenced_input_path), 10, ans1_save_bar_graph_filename)
  ans1_line_graph_data[0].update(ans1_bar_graph_data)
  ans1_line_graph_data[0]["calibration_curve"] = str(ans1_line_graph_data[0]["calibration_curve"])
  save_jsonl(ans1_save_filename, ans1_line_graph_data)
  print(f"Output JSON file: {save_dir / ans1_save_filename}")

  print(f"Input file: {ans1_other2_inferenced_input_path}")
  ans1_other2_line_graph_data = evaluate_line_graph(
      str(ans1_other2_inferenced_input_path), ans1_other2_save_line_graph_filename)
  ans1_other2_bar_graph_data = evaluate_bar_graph(
      str(ans1_other2_inferenced_input_path), 10, ans1_other2_save_bar_graph_filename)
  ans1_other2_line_graph_data[0].update(ans1_other2_bar_graph_data)
  ans1_other2_line_graph_data[0]["calibration_curve"] = str(
      ans1_other2_line_graph_data[0]["calibration_curve"])
  save_jsonl(ans1_other2_save_filename, ans1_other2_line_graph_data)
  print(f"Output JSON file: {save_dir / ans1_other2_save_filename}")

  print(f"Input file: {other3_inferenced_input_path}")
  other3_line_graph_data = evaluate_line_graph(
      str(other3_inferenced_input_path), other3_save_line_graph_filename)
  other3_bar_graph_data = evaluate_bar_graph(
      str(other3_inferenced_input_path), 10, other3_save_bar_graph_filename)
  other3_line_graph_data[0].update(other3_bar_graph_data)
  other3_line_graph_data[0]["calibration_curve"] = str(
      other3_line_graph_data[0]["calibration_curve"])
  save_jsonl(other3_save_filename, other3_line_graph_data)
  print(f"Output JSON file: {save_dir / other3_save_filename}")
